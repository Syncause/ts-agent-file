...
function shouldEnableCommonJsRequireHook() {
...
function installCommonJsRequireHook() {
    ...
    const proto = Module.Module?.prototype || Module.prototype;
    ...
    proto.require = function syncauseTracedRequire(request) {
